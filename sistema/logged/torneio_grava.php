...
if($ID_TORNEIO == ""){
    $insert_torneio = $db_heroes->query("INSERT INTO torneio (NOME, TH, INICIO_INSCRICAO, FINAL_INSCRICAO, INICIO_CLASSIFICATORIA, INICIO_FASE_GRUPO, INICIO_SEMIFINAL, DATA_FINAL, ID_STATUS, ID_USER) VALUES ('" .$NOME. "','" .$TH. "','" .$INICIO_INSC. "','" .$FINAL_INSC. "','" .$CLASSIFICATORIA. "','" .$FASE_GRUPO. "','" .$SEMIFINAL. "','" .$FINAL. "','" .$ID_STATUS. "','" .$id_user. "')");
